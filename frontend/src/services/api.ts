...
async function fetchApi<T>(
  ...
  console.log('fetchApi: Making request to:', url, 'with options:', { ...defaultOptions, ...options })
...
export const conversionsApi = {
  ...
  getAll: async (page = 1, limit = 20, status?: string): Promise<PaginatedResponse<ConversionJob>> => {
